...
<body class="bg-light">
	...
	<br />
	<br />
	<img src="/agendaGabriel/img/erro.png" width="225" height="225" /> <br />
	<br />
	<p class="lead"><%=request.getAttribute("erro")%></p>
	<a href="/agendaGabriel/lista-contatos.jsp?busca="
		class="btn btn-primary">Voltar aos contatos</a> </main>
